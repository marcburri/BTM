...
// ibtm
SEXP ibtm(Rcpp::List biterms, Rcpp::CharacterVector x, int K, int W, double a, double b, int win, int win_nrej, int n_rej, int n_part, int trace, int check_convergence, double convergence_tol, bool background);
RcppExport SEXP _BTM_ibtm(SEXP bitermsSEXP, SEXP xSEXP, SEXP KSEXP, SEXP WSEXP, SEXP aSEXP, SEXP bSEXP, SEXP winSEXP, SEXP win_nrejSEXP, SEXP n_rejSEXP, SEXP n_partSEXP, SEXP traceSEXP, SEXP check_convergenceSEXP, SEXP convergence_tolSEXP, SEXP backgroundSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type biterms(bitermsSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type win(winSEXP);
    Rcpp::traits::input_parameter< int >::type win_nrej(win_nrejSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type convergence_tol(convergence_tolSEXP);
    Rcpp::traits::input_parameter< bool >::type background(backgroundSEXP);
    rcpp_result_gen = Rcpp::wrap(ibtm(biterms, x, K, W, a, b, win, win_nrej, n_rej, n_part, trace, check_convergence, convergence_tol, background));
    return rcpp_result_gen;
END_RCPP
}
// ibtm_biterms
